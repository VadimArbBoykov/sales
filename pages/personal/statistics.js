        ...
        <CenteredBox maxWidth={1200} minWidth={450}>
          ...
          <Box display={'flex'} justifyContent={'center'} alignItems={'center'} width={'100%'} bgcolor={'#fff'} borderRadius={3} sx={{height: {xs: 350, lg: 'auto'}}}>
            <Box display={'flex'} flexDirection={'column'} alignItems={'center'}>
              <BarChartIcon sx={{fontSize: '100px', color: '#252948'}}/>
              <Typography color={'rgba(37,42,72,.71)'} fontSize={'14px'}>Статистика активируется после первого успешного обмена</Typography>
            </Box>
          </Box>
        </CenteredBox>
      </Box>
